...
add_action('admin_enqueue_scripts', function () {
	...
	wp_localize_script('sgits-deactivate-feedback-form-js', 'sgits_deactivate_feedback_form_strings', array(
		'quick_feedback'			=> __('Quick Feedback', 'sg-checkout-location-picker'),
		'foreword'					=> __('If you would be kind enough, please tell us why you\'re deactivating?', 'sg-checkout-location-picker'),
		'better_plugins_name'		=> __('Please tell us which plugin?', 'sg-checkout-location-picker'),
		'please_tell_us'			=> __('Please tell us the reason so we can improve the plugin', 'sg-checkout-location-picker'),
		'do_not_attach_email'		=> __('Do not send my e-mail address with this feedback', 'sg-checkout-location-picker'),

		'brief_description'			=> __('Please give us any feedback that could help us improve', 'sg-checkout-location-picker'),

		'cancel'					=> __('Cancel', 'sg-checkout-location-picker'),
		'skip_and_deactivate'		=> __('Skip &amp; Deactivate', 'sg-checkout-location-picker'),
		'submit_and_deactivate'		=> __('Submit &amp; Deactivate', 'sg-checkout-location-picker'),
		'please_wait'				=> __('Please wait', 'sg-checkout-location-picker'),
		'thank_you'					=> __('Thank you!', 'sg-checkout-location-picker')
	));
	...
	$defaultReasons = array(
		'suddenly-stopped-working'	=> __('The plugin suddenly stopped working', 'sg-checkout-location-picker'),
		'plugin-broke-site'			=> __('The plugin broke my site', 'sg-checkout-location-picker'),
		'no-longer-needed'			=> __('I don\'t need this plugin any more', 'sg-checkout-location-picker'),
		'found-better-plugin'		=> __('I found a better plugin', 'sg-checkout-location-picker'),
		'temporary-deactivation'	=> __('It\'s a temporary deactivation, I\'m troubleshooting', 'sg-checkout-location-picker'),
		'other'						=> __('Other', 'sg-checkout-location-picker')
	);
